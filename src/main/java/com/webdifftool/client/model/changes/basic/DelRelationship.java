...
public class DelRelationship extends BasicChange
{

	public DelRelationship()
	{
		super();
	}

	public DelRelationship(String id, String name, List<String[]> changeValues)
	{
	...
	public String getSimpleHTMLRepresenation()
	{
		...
		result += "<b>" + relation + "</b>, ";
		result += "<FONT COLOR=\"#FF0000\"><i " + this.getNameAsToolTip(concept2) + ">" + concept2 + "</i></FONT> )";
