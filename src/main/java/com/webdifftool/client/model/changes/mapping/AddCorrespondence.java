...
package com.webdifftool.client.model.changes.mapping;
 
import java.util.List;

public class AddCorrespondence extends MappingChange
{

	public AddCorrespondence()
	{
		super();
	}

	public AddCorrespondence(String id, String name, List<String[]> changeValues)
	{
